# Generated by Django 4.2.6 on 2024-01-26 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scrapapp.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('scrap', models.ManyToManyField(related_name='wished_scrap', to='scrapapp.scrap')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scrap', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scrap_review', to='scrapapp.scrap')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scrap', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scrapapp.scrap')),
